...
{	
    ...
    static GUIStyle textNearCursorStyle;
	...
	string[] aoModes = new string[2] {"hemisphere", "high quality"};
	...
	void CreateGuiSkin() {
        ...
        textNearCursorStyle = new GUIStyle();
        textNearCursorStyle.richText = true;
        textNearCursorStyle.alignment = TextAnchor.MiddleLeft;
	...
	*/
    ...
    static Renderer texturePreviewComposerRenderer;
			...
			if (Surforge.surforgeSettings) {
...
#if UNITY_2019_1_OR_NEWER
                        DrawMaterialDragDropIcons(230);
#else
                        DrawMaterialDragDropIcons(220);
#endif
                ...
                if (materialEditor != null) {
					...
					if (Event.current.type == EventType.Layout) {
                        if (texturePreviewComposerRenderer == null) {
                            texturePreviewComposerRenderer = (Renderer)Surforge.surforgeSettings.extentTexturePreview.composer.GetComponent<Renderer>();
                        }

						if (texturePreviewComposerRenderer != null) {
                            texturePreviewComposerRenderer.sharedMaterial.SetFloat("_ShowID", (float)Surforge.surforgeSettings.activeShowID );
						}
					}
				...
				if (texturePreviewComposerRenderer != null) {
                    texturePreviewComposerRenderer.sharedMaterial.SetFloat("_ShowMaps", shaderMode);
				}
	...
	*/
    ...
    static SceneView sceneviewWasUnderCursorLastTime;
    ...
    private static void SurforgeOnScene(SceneView sceneview) {
        ...
        if (SceneView.mouseOverWindow == sceneview) {
            sceneviewWasUnderCursorLastTime = sceneview;
        }

        bool isExtraSceneView = false;
		if (SceneView.sceneViews.Count > 1) {
            if (sceneviewWasUnderCursorLastTime != sceneview) {
                isExtraSceneView = true;
            }
		}
        ...
        if (!isExtraSceneView) {
                ...
                if (Surforge.surforgeSettings.isPlaceToolActive) {
                    if (Surforge.surforgeSettings.placeMeshes.placeMeshes[Surforge.surforgeSettings.activePlaceMesh].shuffleArray != null) {
                        if (Surforge.surforgeSettings.placeMeshes.placeMeshes[Surforge.surforgeSettings.activePlaceMesh].shuffleArray.Length > 0) {
                            if (textNearCursorStyle != null) {
                                DrawTextNearCursor("Has variants", "Right Click", "shuffle");
                            }
                        }
                    }
                }
            ...
            //no sufrorge setttings found
                ...
                Surforge.surforgeSettings = FindFirstObjectByType<SurforgeSettings>();
#else
    ...
    static MeshFilter texturePreviewComposerMeshFilter;
    static void CheckUVsChanged() {
        if (texturePreviewComposerMeshFilter == null) {
            texturePreviewComposerMeshFilter = Surforge.surforgeSettings.extentTexturePreview.composer.GetComponent<MeshFilter>();
        }
		if (texturePreviewComposerMeshFilter != null) {

			mesh = texturePreviewComposerMeshFilter.sharedMesh;
...
// ------------------------------------------------------------------------------
	...
	static void ShowLimits() {
        ...
        var fmh_6668_92_638982189905979306 = Quaternion.identity; centerHandle = Handles.FreeMoveHandle(centerHandle + new Vector3(0.25f, 0, 0.25f), HandleUtility.GetHandleSize(handleMaxX) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
...
#if UNITY_5_5_OR_NEWER
                var fmh_6703_100_638982189905997155 = Quaternion.identity; handleMaxX = Handles.FreeMoveHandle(handleMaxXFlat + new Vector3(0.25f, 0, 0.25f), HandleUtility.GetHandleSize(handleMaxX) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
...
#if UNITY_5_5_OR_NEWER
                var fmh_6711_96_638982189905998522 = Quaternion.identity; handleMaxX = Handles.FreeMoveHandle(handleMaxX + new Vector3(0.25f, 0, 0.25f), HandleUtility.GetHandleSize(handleMaxX) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
...
#if UNITY_5_5_OR_NEWER
                var fmh_6727_100_638982189906000180 = Quaternion.identity; handleMinX = Handles.FreeMoveHandle(handleMinXFlat + new Vector3(0.25f, 0, 0.25f), HandleUtility.GetHandleSize(handleMinX) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
...
#if UNITY_5_5_OR_NEWER
                var fmh_6735_96_638982189906001039 = Quaternion.identity; handleMinX = Handles.FreeMoveHandle(handleMinX + new Vector3(0.25f, 0, 0.25f), HandleUtility.GetHandleSize(handleMinX) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
		...
		if (sceneCameraDirection != 1) {
#if UNITY_5_5_OR_NEWER
            var fmh_6749_92_638982189906002293 = Quaternion.identity; handleMaxY = Handles.FreeMoveHandle(handleMaxY + new Vector3(0.25f, 0, 0.25f), HandleUtility.GetHandleSize(handleMaxY) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
		...
		if (sceneCameraDirection != 1) {
#if UNITY_5_5_OR_NEWER
            var fmh_6762_92_638982189906003495 = Quaternion.identity; handleMinY = Handles.FreeMoveHandle(handleMinY + new Vector3(0.25f, 0, 0.25f), HandleUtility.GetHandleSize(handleMinY) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
...
#if UNITY_5_5_OR_NEWER
                var fmh_6777_100_638982189906004924 = Quaternion.identity; handleMaxZ = Handles.FreeMoveHandle(handleMaxZFlat + new Vector3(0.25f, 0, 0.25f), HandleUtility.GetHandleSize(handleMaxZ) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
...
#if UNITY_5_5_OR_NEWER
                var fmh_6785_96_638982189906005762 = Quaternion.identity; handleMaxZ = Handles.FreeMoveHandle(handleMaxZ + new Vector3(0.25f, 0, 0.25f), HandleUtility.GetHandleSize(handleMaxZ) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
...
#if UNITY_5_5_OR_NEWER
                var fmh_6801_100_638982189906010235 = Quaternion.identity; handleMinZ = Handles.FreeMoveHandle(handleMinZFlat + new Vector3(0.25f, 0, 0.25f), HandleUtility.GetHandleSize(handleMinZ) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
...
#if UNITY_5_5_OR_NEWER
                var fmh_6809_96_638982189906012527 = Quaternion.identity; handleMinZ = Handles.FreeMoveHandle(handleMinZ + new Vector3(0.25f, 0, 0.25f), HandleUtility.GetHandleSize(handleMinZ) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
	...
	static void ShowTextureBorders() {
		...
		if (Surforge.surforgeSettings.showTextureEdges) {
            ...
            if (!limitsActive) {
#if UNITY_5_5_OR_NEWER
                var fmh_6846_93_638982189906016799 = Quaternion.identity; textureBordersHandleMaxX = Handles.FreeMoveHandle(textureBordersHandleMaxX, HandleUtility.GetHandleSize(textureBordersHandleMaxX) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
                textureBordersHandleMaxX = Handles.FreeMoveHandle(textureBordersHandleMaxX, Quaternion.identity, HandleUtility.GetHandleSize(textureBordersHandleMaxX) * handleSizeMult, snapLimit, Handles.DotCap);
#endif
            }
            ...
            if (!limitsActive) {
#if UNITY_5_5_OR_NEWER
                var fmh_6858_93_638982189906019569 = Quaternion.identity; textureBordersHandleMinX = Handles.FreeMoveHandle(textureBordersHandleMinX, HandleUtility.GetHandleSize(textureBordersHandleMinX) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
                textureBordersHandleMinX = Handles.FreeMoveHandle(textureBordersHandleMinX, Quaternion.identity, HandleUtility.GetHandleSize(textureBordersHandleMinX) * handleSizeMult, snapLimit, Handles.DotCap);
#endif
            }
            ...
            if (!limitsActive) {
#if UNITY_5_5_OR_NEWER
                var fmh_6871_93_638982189906021519 = Quaternion.identity; textureBordersHandleMaxZ = Handles.FreeMoveHandle(textureBordersHandleMaxZ, HandleUtility.GetHandleSize(textureBordersHandleMaxZ) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
                textureBordersHandleMaxZ = Handles.FreeMoveHandle(textureBordersHandleMaxZ, Quaternion.identity, HandleUtility.GetHandleSize(textureBordersHandleMaxZ) * handleSizeMult, snapLimit, Handles.DotCap);
#endif
            }
            ...
            if (!limitsActive) {
#if UNITY_5_5_OR_NEWER
                var fmh_6883_93_638982189906024433 = Quaternion.identity; textureBordersHandleMinZ = Handles.FreeMoveHandle(textureBordersHandleMinZ, HandleUtility.GetHandleSize(textureBordersHandleMinZ) * handleSizeMult, snapLimit, Handles.DotHandleCap);
#else
                textureBordersHandleMinZ = Handles.FreeMoveHandle(textureBordersHandleMinZ, Quaternion.identity, HandleUtility.GetHandleSize(textureBordersHandleMinZ) * handleSizeMult, snapLimit, Handles.DotCap);
#endif
            }
	...
	static void PlaceTool() {
        ...
        //Disable right mouse button for Unity Editor default Camera Orbit
    ...
    static MeshCollider polygonLassoPlaneMeshCollider;
    ...
    static void RaycastPolygonLasso() {  //selects only if have collider component
		...
		if (Surforge.surforgeSettings.polygonLassoPlane != null) {
            if (polygonLassoPlaneMeshCollider == null) {
                polygonLassoPlaneMeshCollider = (MeshCollider)Surforge.surforgeSettings.polygonLassoPlane.GetComponent<MeshCollider>();
            }
			
			if (polygonLassoPlaneMeshCollider.Raycast(ray, out hit, 1000.0f)) {
...
#if UNITY_5_5_OR_NEWER
        Handles.CubeHandleCap(0, snappedPoint, Quaternion.identity, HandleUtility.GetHandleSize(snappedPoint) * 0.06f, EventType.Repaint);
#else
...
#if UNITY_5_5_OR_NEWER
            Handles.CircleHandleCap(0, snappedPoint, Quaternion.Euler(90.0f, 0, 0), HandleUtility.GetHandleSize(snappedPoint) * 0.1f, EventType.Repaint);
#else
...
#if UNITY_5_5_OR_NEWER
                Handles.CubeHandleCap(0, polygonLassoPoints[i], Quaternion.identity, HandleUtility.GetHandleSize(polygonLassoPoints[i]) * 0.06f, EventType.Repaint);
#else
...
#if UNITY_5_5_OR_NEWER
            Handles.CircleHandleCap(0, snappedPoint, Quaternion.Euler(90.0f, 0, 0), HandleUtility.GetHandleSize(snappedPoint) * polyLassoScale * 0.1f, EventType.Repaint);
#else
...
#if UNITY_5_5_OR_NEWER
                    Handles.CubeHandleCap(0, points[0], Quaternion.identity, HandleUtility.GetHandleSize(points[0]) * 0.06f, EventType.Repaint);
#else
...
#if UNITY_5_5_OR_NEWER
                Handles.CubeHandleCap(0, polygonLassoChildPoints[i], Quaternion.identity, HandleUtility.GetHandleSize(polygonLassoChildPoints[i]) * 0.06f, EventType.Repaint);
#else
...
#if UNITY_5_5_OR_NEWER
                    Handles.CubeHandleCap(0, circleCenter, Quaternion.identity, HandleUtility.GetHandleSize(circleCenter) * 0.06f, EventType.Repaint);
#else
...
#if UNITY_5_5_OR_NEWER
            Handles.CubeHandleCap(0, line[i], Quaternion.identity, HandleUtility.GetHandleSize(line[i]) * 0.06f, EventType.Repaint);
#else
            Handles.CubeCap(0, line[i], Quaternion.identity, HandleUtility.GetHandleSize(line[i]) * 0.06f);
#endif
        }
#if UNITY_5_5_OR_NEWER
        Handles.CubeHandleCap(0, activePoint, Quaternion.identity, HandleUtility.GetHandleSize(activePoint) * 0.06f, EventType.Repaint);
#else
			...
			if (Surforge.surforgeSettings.extentTexturePreview != null) {
				if (Surforge.surforgeSettings.extentTexturePreview.previewCamera != null) {
					...
					if (Physics.Raycast(ray, out hit)) {
						...
						Material activeMaterial = texturePreviewComposerRenderer.sharedMaterial;
    ...
    static void DrawTextNearCursor(string descrition, string hotkey, string action) {
        GUIContent firstString = new GUIContent("<color=#ffffff>" + descrition + "</color>");
        GUIContent secondString = new GUIContent("<color=" + textHotkeyColorDark + ">" + hotkey + "</color>" + "<color=#ffffff>" + ": " + action + "</color>");


        Vector2 mousePos = Event.current.mousePosition;

        Handles.BeginGUI();
        GUILayout.BeginArea(new Rect( (mousePos.x + 45.0f), (mousePos.y - 14.0f), 200, 100));

        GUILayout.Label(firstString, textNearCursorStyle);
        GUILayout.Label(secondString, textNearCursorStyle);

Shader "Hidden/Id6" {
    Properties
    {
    	_Color ("Main Color", Color) = (0.2,0.4,0.4,1)
    ...
    SubShader
    {
        Tags {"Surforge"="Opaque" "SurforgeMaterialId" = "6" "SurforgeId6" = "6" "Base" = "0" "Floater" = "0" "SurforgeEmissionId" = "3" "DisableBatching" = "True"}
        LOD 200

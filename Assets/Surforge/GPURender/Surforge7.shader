Shader "Hidden/Id7" {
    Properties
    {
    	_Color ("Main Color", Color) = (0.4,0.2,0.4,1)
    ...
    SubShader
    {
        Tags {"Surforge"="Opaque" "SurforgeMaterialId" = "7" "SurforgeId7" = "7" "Base" = "0" "Floater" = "0" "SurforgeEmissionId" = "3" "DisableBatching" = "True"}
        LOD 200

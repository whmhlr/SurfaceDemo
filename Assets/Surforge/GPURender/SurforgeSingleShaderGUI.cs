...
public class SurforgeSingleShaderGUI : ShaderGUI {
	...
	public override void OnGUI (MaterialEditor materialEditor, MaterialProperty[] props) {
        ...
        GUILayout.BeginVertical(boxStyle);
        materialEditor.RangeProperty(_0MAlbedoIntensity, "M Albedo Intensity");
        GUILayout.EndVertical();

        GUILayout.BeginVertical(boxStyle);
        GUILayout.BeginHorizontal();
        GUILayout.Label("M Albedo Tint");
        controlRect = EditorGUILayout.GetControlRect();
        colorRect = new Rect(controlRect.xMax - colorRectWidth, controlRect.yMin, colorRectWidth, colorRectHeigth);
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Label("M Underlying Diffuse");
        controlRect = EditorGUILayout.GetControlRect();
        colorRect = new Rect(controlRect.xMax - colorRectWidth, controlRect.yMin, colorRectWidth, colorRectHeigth);
		...
		*/
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Label("Paint 1 M Color");
        controlRect = EditorGUILayout.GetControlRect();
        colorRect = new Rect(controlRect.xMax - colorRectWidth, controlRect.yMin, colorRectWidth, colorRectHeigth);
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Label("Paint 2 M Color");
        controlRect = EditorGUILayout.GetControlRect();
        colorRect = new Rect(controlRect.xMax - colorRectWidth, controlRect.yMin, colorRectWidth, colorRectHeigth);

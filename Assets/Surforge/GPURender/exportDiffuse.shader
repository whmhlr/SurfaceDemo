 		...
 		Pass{
			...
			half _0AlbedoIntensity;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				//Diffuse
				fixed4 diffuse = GetDiffuse(objectTexture0 * _0AlbedoIntensity + 1 * (1 - _0AlbedoIntensity), _Tint0, paintMask1, paintMask2, _0Paint1Color, _0Paint2Color, paintCol1, paintCol2, objectLabelAlpha, objectLabel, dirts1Mask, dirts2Mask, dirts1, dirts2, _0UnderlyingDiffuseTint, wornEdges, _0WornEdgesBorderTint, _0UnderlyingDiffuse, wornEdgesCenter);
				...
				float4 finalColor = fixed4(finalAlbedoLevels.r, finalAlbedoLevels.g, finalAlbedoLevels.b, 1);
   				...
   				return applyHSBEffect(finalColor, float4(_Hue, _Brightness, _Contrast, _Saturation));
  			}
  			ENDCG
 		}
 		...
 		Blend SrcAlpha OneMinusSrcAlpha
			...
			half _1AlbedoIntensity;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				//Diffuse
				fixed4 diffuse = GetDiffuse(objectTexture1 * _1AlbedoIntensity + 1 * (1 - _1AlbedoIntensity), _Tint1, paintMask1, paintMask2, _1Paint1Color, _1Paint2Color, paintCol1, paintCol2, objectLabelAlpha, objectLabel, dirts1Mask, dirts2Mask, dirts1, dirts2, _1UnderlyingDiffuseTint, wornEdges, _1WornEdgesBorderTint, _1UnderlyingDiffuse, wornEdgesCenter);
				...
				float4 finalColor = fixed4(finalAlbedoLevels.r, finalAlbedoLevels.g, finalAlbedoLevels.b, 1);
   				...
   				return applyHSBEffect(finalColor, float4(_Hue, _Brightness, _Contrast, _Saturation)) * objectMasks.g;
  			}
  			ENDCG
 		}
 		...
 		Blend SrcAlpha OneMinusSrcAlpha
			...
			half _2AlbedoIntensity;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				//Diffuse
				fixed4 diffuse = GetDiffuse(objectTexture2 * _2AlbedoIntensity + 1 * (1 - _2AlbedoIntensity), _Tint2, paintMask1, paintMask2, _2Paint1Color, _2Paint2Color, paintCol1, paintCol2, objectLabelAlpha, objectLabel, dirts1Mask, dirts2Mask, dirts1, dirts2, _2UnderlyingDiffuseTint, wornEdges, _2WornEdgesBorderTint, _2UnderlyingDiffuse, wornEdgesCenter);
				...
				float4 finalColor = fixed4(finalAlbedoLevels.r, finalAlbedoLevels.g, finalAlbedoLevels.b, 1);
   				...
   				return applyHSBEffect(finalColor, float4(_Hue, _Brightness, _Contrast, _Saturation)) * objectMasks.b;
  			}
  			ENDCG
 		}
 		...
 		Blend SrcAlpha OneMinusSrcAlpha
			...
			half _3AlbedoIntensity;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				//Diffuse
				fixed4 diffuse = GetDiffuse(objectTexture3 * _3AlbedoIntensity + 1 * (1 - _3AlbedoIntensity), _Tint3, paintMask1, paintMask2, _3Paint1Color, _3Paint2Color, paintCol1, paintCol2, objectLabelAlpha, objectLabel, dirts1Mask, dirts2Mask, dirts1, dirts2, _3UnderlyingDiffuseTint, wornEdges, _3WornEdgesBorderTint, _3UnderlyingDiffuse, wornEdgesCenter);
				...
				float4 finalColor = fixed4(finalAlbedoLevels.r, finalAlbedoLevels.g, finalAlbedoLevels.b, 1);
   				...
   				return applyHSBEffect(finalColor, float4(_Hue, _Brightness, _Contrast, _Saturation)) * objectMasks.a;
  			}
  			ENDCG
 		}
 		...
 		Blend SrcAlpha OneMinusSrcAlpha
			...
			half _4AlbedoIntensity;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				//Diffuse
				fixed4 diffuse = GetDiffuse(objectTexture4 * _4AlbedoIntensity + 1 * (1 - _4AlbedoIntensity), _Tint4, paintMask1, paintMask2, _4Paint1Color, _4Paint2Color, paintCol1, paintCol2, objectLabelAlpha, objectLabel, dirts1Mask, dirts2Mask, dirts1, dirts2, _4UnderlyingDiffuseTint, wornEdges, _4WornEdgesBorderTint, _4UnderlyingDiffuse, wornEdgesCenter);
				...
				float4 finalColor = fixed4(finalAlbedoLevels.r, finalAlbedoLevels.g, finalAlbedoLevels.b, 1);
   				...
   				return applyHSBEffect(finalColor, float4(_Hue, _Brightness, _Contrast, _Saturation)) * objectMasks.r;
  			}
  			ENDCG
 		}
 		...
 		Blend SrcAlpha OneMinusSrcAlpha
			...
			half _5AlbedoIntensity;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				//Diffuse
				fixed4 diffuse = GetDiffuse(objectTexture5 * _5AlbedoIntensity + 1 * (1 - _5AlbedoIntensity), _Tint5, paintMask1, paintMask2, _5Paint1Color, _5Paint2Color, paintCol1, paintCol2, objectLabelAlpha, objectLabel, dirts1Mask, dirts2Mask, dirts1, dirts2, _5UnderlyingDiffuseTint, wornEdges, _5WornEdgesBorderTint, _5UnderlyingDiffuse, wornEdgesCenter);
 		...
 		Blend SrcAlpha OneMinusSrcAlpha
			...
			half _6AlbedoIntensity;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				//Diffuse
				fixed4 diffuse = GetDiffuse(objectTexture6 * _6AlbedoIntensity + 1 * (1 - _6AlbedoIntensity), _Tint6, paintMask1, paintMask2, _6Paint1Color, _6Paint2Color, paintCol1, paintCol2, objectLabelAlpha, objectLabel, dirts1Mask, dirts2Mask, dirts1, dirts2, _6UnderlyingDiffuseTint, wornEdges, _6WornEdgesBorderTint, _6UnderlyingDiffuse, wornEdgesCenter);
 		...
 		Blend SrcAlpha OneMinusSrcAlpha
			...
			half _7AlbedoIntensity;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				//Diffuse
				fixed4 diffuse = GetDiffuse(objectTexture7 * _7AlbedoIntensity + 1 * (1 - _7AlbedoIntensity), _Tint7, paintMask1, paintMask2, _7Paint1Color, _7Paint2Color, paintCol1, paintCol2, objectLabelAlpha, objectLabel, dirts1Mask, dirts2Mask, dirts1, dirts2, _7UnderlyingDiffuseTint, wornEdges, _7WornEdgesBorderTint, _7UnderlyingDiffuse, wornEdgesCenter);

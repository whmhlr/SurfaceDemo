...
Shader "Hidden/ExportGlossiness" {
	Properties {
			...
			half _0Paint2Transparency;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap0 > 0.5) {				
					if (_GlossinessFromAlpha0 > 0.5) objectTexture0gloss = GetGlossMap(tex2D(_SpecularMap0, i.texcoord_BumpMap0 / _GlobalScale).a, _0GlossinessContrast, _0GlossinessBrightness);
					else {
						if (_LinearColorSpace != 0) objectTexture0gloss = GetGlossMap(pow (tex2D(_SpecularMap0, i.texcoord_BumpMap0 / _GlobalScale), 0.454545), _0GlossinessContrast, _0GlossinessBrightness);	
						else objectTexture0gloss = GetGlossMap(tex2D(_SpecularMap0, i.texcoord_BumpMap0 / _GlobalScale), _0GlossinessContrast, _0GlossinessBrightness);	
					}
					...
					if (_LinearColorSpace != 0) objectTexture0gloss = GetGlossMap(pow (tex2D(_Texture0, i.texcoord_Texture0 / _GlobalScale), 0.454545), _0GlossinessContrast, _0GlossinessBrightness);
					else objectTexture0gloss = GetGlossMap(tex2D(_Texture0, i.texcoord_Texture0 / _GlobalScale), _0GlossinessContrast, _0GlossinessBrightness);
   				...
   				return fixed4 (resultGlossinessMap.r, resultGlossinessMap.r, resultGlossinessMap.r, 1);
  			}
  			ENDCG
 		}
			...
			half _1Paint2Transparency;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap1 > 0.5) {				
					if (_GlossinessFromAlpha1 > 0.5) objectTexture1gloss = GetGlossMap(tex2D(_SpecularMap1, i.texcoord_BumpMap1 / _GlobalScale).a, _1GlossinessContrast, _1GlossinessBrightness);
					else {
						if (_LinearColorSpace != 0) objectTexture1gloss = GetGlossMap(pow (tex2D(_SpecularMap1, i.texcoord_BumpMap1 / _GlobalScale), 0.454545), _1GlossinessContrast, _1GlossinessBrightness);	
						else objectTexture1gloss = GetGlossMap(tex2D(_SpecularMap1, i.texcoord_BumpMap1 / _GlobalScale), _1GlossinessContrast, _1GlossinessBrightness);	
					}
					...
					if (_LinearColorSpace != 0) objectTexture1gloss = GetGlossMap(pow (tex2D(_Texture1, i.texcoord_Texture1 / _GlobalScale), 0.454545), _1GlossinessContrast, _1GlossinessBrightness);
					else objectTexture1gloss = GetGlossMap(tex2D(_Texture1, i.texcoord_Texture1 / _GlobalScale), _1GlossinessContrast, _1GlossinessBrightness);
   				...
   				return fixed4 (resultGlossinessMap.r, resultGlossinessMap.r, resultGlossinessMap.r, objectMasks.g);
  			}
  			ENDCG
 		}
			...
			half _2Paint2Transparency;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap2 > 0.5) {				
					if (_GlossinessFromAlpha2 > 0.5) objectTexture2gloss = GetGlossMap(tex2D(_SpecularMap2, i.texcoord_BumpMap2 / _GlobalScale).a, _2GlossinessContrast, _2GlossinessBrightness);
					else {
						if (_LinearColorSpace != 0) objectTexture2gloss = GetGlossMap(pow (tex2D(_SpecularMap2, i.texcoord_BumpMap2 / _GlobalScale), 0.454545), _2GlossinessContrast, _2GlossinessBrightness);	
						else objectTexture2gloss = GetGlossMap(tex2D(_SpecularMap2, i.texcoord_BumpMap2 / _GlobalScale), _2GlossinessContrast, _2GlossinessBrightness);	
					}
					...
					if (_LinearColorSpace != 0) objectTexture2gloss = GetGlossMap(pow (tex2D(_Texture2, i.texcoord_Texture2 / _GlobalScale), 0.454545), _2GlossinessContrast, _2GlossinessBrightness);
					else objectTexture2gloss = GetGlossMap(tex2D(_Texture2, i.texcoord_Texture2 / _GlobalScale), _2GlossinessContrast, _2GlossinessBrightness);
   				...
   				return fixed4 (resultGlossinessMap.r, resultGlossinessMap.r, resultGlossinessMap.r, objectMasks.b);
  			}
  			ENDCG
 		}
			...
			half _3Paint2Transparency;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap3 > 0.5) {				
					if (_GlossinessFromAlpha3 > 0.5) objectTexture3gloss = GetGlossMap(tex2D(_SpecularMap3, i.texcoord_BumpMap3 / _GlobalScale).a, _3GlossinessContrast, _3GlossinessBrightness);
					else {
						if (_LinearColorSpace != 0) objectTexture3gloss = GetGlossMap(pow (tex2D(_SpecularMap3, i.texcoord_BumpMap3 / _GlobalScale), 0.454545), _3GlossinessContrast, _3GlossinessBrightness);	
						else objectTexture3gloss = GetGlossMap(tex2D(_SpecularMap3, i.texcoord_BumpMap3 / _GlobalScale), _3GlossinessContrast, _3GlossinessBrightness);	
					}
					...
					if (_LinearColorSpace != 0) objectTexture3gloss = GetGlossMap(pow (tex2D(_Texture3, i.texcoord_Texture3 / _GlobalScale), 0.454545), _3GlossinessContrast, _3GlossinessBrightness);
					else objectTexture3gloss = GetGlossMap(tex2D(_Texture3, i.texcoord_Texture3 / _GlobalScale), _3GlossinessContrast, _3GlossinessBrightness);
   				...
   				return fixed4 (resultGlossinessMap.r, resultGlossinessMap.r, resultGlossinessMap.r, objectMasks.a);
  			}
  			ENDCG
 		}
			...
			half _4Paint2Transparency;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap4 > 0.5) {				
					if (_GlossinessFromAlpha4 > 0.5) objectTexture4gloss = GetGlossMap(tex2D(_SpecularMap4, i.texcoord_BumpMap4 / _GlobalScale).a, _4GlossinessContrast, _4GlossinessBrightness);
					else {
						if (_LinearColorSpace != 0) objectTexture4gloss = GetGlossMap(pow (tex2D(_SpecularMap4, i.texcoord_BumpMap4 / _GlobalScale), 0.454545), _4GlossinessContrast, _4GlossinessBrightness);	
						else objectTexture4gloss = GetGlossMap(tex2D(_SpecularMap4, i.texcoord_BumpMap4 / _GlobalScale), _4GlossinessContrast, _4GlossinessBrightness);	
					}
					...
					if (_LinearColorSpace != 0) objectTexture4gloss = GetGlossMap(pow (tex2D(_Texture4, i.texcoord_Texture4 / _GlobalScale), 0.454545), _4GlossinessContrast, _4GlossinessBrightness);
					else objectTexture4gloss = GetGlossMap(tex2D(_Texture4, i.texcoord_Texture4 / _GlobalScale), _4GlossinessContrast, _4GlossinessBrightness);
   				...
   				return fixed4 (resultGlossinessMap.r, resultGlossinessMap.r, resultGlossinessMap.r, objectMasks.r);
  			}
  			ENDCG
 		}
			...
			half _5Paint2Transparency;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap5 > 0.5) {				
					if (_GlossinessFromAlpha5 > 0.5) objectTexture5gloss = GetGlossMap(tex2D(_SpecularMap5, i.texcoord_BumpMap5 / _GlobalScale).a, _5GlossinessContrast, _5GlossinessBrightness);
					else {
						if (_LinearColorSpace != 0) objectTexture5gloss = GetGlossMap(pow (tex2D(_SpecularMap5, i.texcoord_BumpMap5 / _GlobalScale), 0.454545), _5GlossinessContrast, _5GlossinessBrightness);	
						else objectTexture5gloss = GetGlossMap(tex2D(_SpecularMap5, i.texcoord_BumpMap5 / _GlobalScale), _5GlossinessContrast, _5GlossinessBrightness);	
					}
					...
					if (_LinearColorSpace != 0) objectTexture5gloss = GetGlossMap(pow (tex2D(_Texture5, i.texcoord_Texture5 / _GlobalScale), 0.454545), _5GlossinessContrast, _5GlossinessBrightness);
					else objectTexture5gloss = GetGlossMap(tex2D(_Texture5, i.texcoord_Texture5 / _GlobalScale), _5GlossinessContrast, _5GlossinessBrightness);
			...
			half _6Paint2Transparency;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap6 > 0.5) {				
					if (_GlossinessFromAlpha6 > 0.5) objectTexture6gloss = GetGlossMap(tex2D(_SpecularMap6, i.texcoord_BumpMap6 / _GlobalScale).a, _6GlossinessContrast, _6GlossinessBrightness);
					else {
						if (_LinearColorSpace != 0) objectTexture6gloss = GetGlossMap(pow (tex2D(_SpecularMap6, i.texcoord_BumpMap6 / _GlobalScale), 0.454545), _6GlossinessContrast, _6GlossinessBrightness);	
						else objectTexture6gloss = GetGlossMap(tex2D(_SpecularMap6, i.texcoord_BumpMap6 / _GlobalScale), _6GlossinessContrast, _6GlossinessBrightness);	
					}
					...
					if (_LinearColorSpace != 0) objectTexture6gloss = GetGlossMap(pow (tex2D(_Texture6, i.texcoord_Texture6 / _GlobalScale), 0.454545), _6GlossinessContrast, _6GlossinessBrightness);
					else objectTexture6gloss = GetGlossMap(tex2D(_Texture6, i.texcoord_Texture6 / _GlobalScale), _6GlossinessContrast, _6GlossinessBrightness);
			...
			half _7Paint2Transparency;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap7 > 0.5) {				
					if (_GlossinessFromAlpha7 > 0.5) objectTexture7gloss = GetGlossMap(tex2D(_SpecularMap7, i.texcoord_BumpMap7 / _GlobalScale).a, _7GlossinessContrast, _7GlossinessBrightness);
					else {
						if (_LinearColorSpace != 0) objectTexture7gloss = GetGlossMap(pow (tex2D(_SpecularMap7, i.texcoord_BumpMap7 / _GlobalScale), 0.454545), _7GlossinessContrast, _7GlossinessBrightness);	
						else objectTexture7gloss = GetGlossMap(tex2D(_SpecularMap7, i.texcoord_BumpMap7 / _GlobalScale), _7GlossinessContrast, _7GlossinessBrightness);	
					}
					...
					if (_LinearColorSpace != 0) objectTexture7gloss = GetGlossMap(pow (tex2D(_Texture7, i.texcoord_Texture7 / _GlobalScale), 0.454545), _7GlossinessContrast, _7GlossinessBrightness);
					else objectTexture7gloss = GetGlossMap(tex2D(_Texture7, i.texcoord_Texture7 / _GlobalScale), _7GlossinessContrast, _7GlossinessBrightness);

			...
			fixed4 _0Paint2MColor;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap0 > 0.5) {
   				...
   				return fixed4 (resultSpecularMap.r, 0, 0, 1);
  			}
  			ENDCG
 		}
			...
			fixed4 _1Paint2MColor;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap1 > 0.5) {
   				...
   				return fixed4 (resultSpecularMap.r, 0, 0, 1) * objectMasks.g;
  			}
  			ENDCG
 		}
			...
			fixed4 _2Paint2MColor;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap2 > 0.5) {
   				...
   				return fixed4 (resultSpecularMap.r, 0, 0, 1) * objectMasks.b;
  			}
  			ENDCG
 		}
			...
			fixed4 _3Paint2MColor;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap3 > 0.5) {
   				...
   				return fixed4 (resultSpecularMap.r, 0, 0, 1) * objectMasks.a;
  			}
  			ENDCG
 		}
			...
			fixed4 _4Paint2MColor;
  			...
  			fixed4 frag (v2f i) : COLOR{
				...
				if (_UseSpecularMap4 > 0.5) {
   				...
   				return fixed4 (resultSpecularMap.r, 0, 0, 1) * objectMasks.r;
  			}
  			ENDCG
 		}

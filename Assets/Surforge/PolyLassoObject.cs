...
public class PolyLassoObject : MonoBehaviour {
    ...
    public float[] scatterStepsX;
    public float[] scatterStepsZ;
    public bool isChain;
    public bool isScalePattern;
    public float chainCrossAngle;
    public Mesh[] scatterObjects;
    public Vector3[] scatterObjectsScales;
    public bool isShuffleScatterObjects;
    public Vector3[] scatterRandomDegrees;
    public Vector3[] scatterRandomOffsets;
    public Vector3[] scatterRandomScales;

    public Mesh scatterFirstObject;
    public Mesh scatterLastObject;
    public bool skipFirstScatter;
    public bool skipLastScatter;
    public float scatterTwistAngle;

    public bool isScatterRandomizeAppearance;
    public int scatterAppearRandomSeed;
    public int scatterAppearRandomMin;
    public int scatterAppearRandomMax;
    public int scatterTRSRandomSeed;

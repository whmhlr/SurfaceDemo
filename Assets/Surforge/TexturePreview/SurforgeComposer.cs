...
public class SurforgeComposer : MonoBehaviour {
	...
	void UpdateComposerMaterialAsset(Material mat) {
		if (surforgeSettings.composerMaterialAsset == null) {
			surforgeSettings.composerMaterialAsset = (Material)AssetDatabase.LoadAssetAtPath(surforgeSettings.surforgePath + "/TexturePreview/composerMaterial.mat", typeof(Material));
			//Debug.Log (surforgeSettings.composerMaterialAsset);
		}

        //enable texture preview camera if using color picker
        if (IsMaterialColorFieldChanged(mat, surforgeSettings.composerMaterialAsset)) {
            surforgeSettings.extentTexturePreview.previewCamera.enabled = true;
            surforgeSettings.cameraDeactivateTimer = Time.realtimeSinceStartup + 0.5f;
        }
    ...
    bool IsMaterialColorFieldChanged(Material sourceMaterial, Material destMaterial) {
        for (int i = 0; i < 8; i++) {
            if (destMaterial.GetColor("_Tint" + i) != sourceMaterial.GetColor("_Tint" + i)) return true;
            if (destMaterial.GetColor("_SpecularTint" + i) != sourceMaterial.GetColor("_SpecularTint" + i)) return true;
            if (destMaterial.GetColor("_" + i + "WornEdgesBorderTint") != sourceMaterial.GetColor("_" + i + "WornEdgesBorderTint")) return true;
            if (destMaterial.GetColor("_" + i + "UnderlyingDiffuseTint") != sourceMaterial.GetColor("_" + i + "UnderlyingDiffuseTint")) return true;
            if (destMaterial.GetColor("_" + i + "UnderlyingSpecularTint") != sourceMaterial.GetColor("_" + i + "UnderlyingSpecularTint")) return true;
            if (destMaterial.GetColor("_" + i + "Paint1Color") != sourceMaterial.GetColor("_" + i + "Paint1Color")) return true;
            if (destMaterial.GetColor("_" + i + "Paint2Color") != sourceMaterial.GetColor("_" + i + "Paint2Color")) return true;
            if (destMaterial.GetColor("_EmissionMapTint" + i) != sourceMaterial.GetColor("_EmissionMapTint" + i)) return true;
            if (destMaterial.GetColor("_MTint" + i) != sourceMaterial.GetColor("_MTint" + i)) return true;
            if (destMaterial.GetColor("_" + i + "MUnderlyingDiffuseTint") != sourceMaterial.GetColor("_" + i + "MUnderlyingDiffuseTint")) return true;
            if (destMaterial.GetColor("_" + i + "Paint1MColor") != sourceMaterial.GetColor("_" + i + "Paint1MColor")) return true;
            if (destMaterial.GetColor("_" + i + "Paint2MColor") != sourceMaterial.GetColor("_" + i + "Paint2MColor")) return true;

            if (destMaterial.GetTexture("_" + i + "Paint1MaskTex") != sourceMaterial.GetTexture("_" + i + "Paint1MaskTex")) return true;
            if (destMaterial.GetTexture("_" + i + "Paint2MaskTex") != sourceMaterial.GetTexture("_" + i + "Paint2MaskTex")) return true;
            if (destMaterial.GetTexture("_Texture" + i) != sourceMaterial.GetTexture("_Texture" + i)) return true;
            if (destMaterial.GetTexture("_BumpMap" + i) != sourceMaterial.GetTexture("_BumpMap" + i)) return true;
            if (destMaterial.GetTexture("_OcclusionMap" + i) != sourceMaterial.GetTexture("_OcclusionMap" + i)) return true;
            if (destMaterial.GetTexture("_SpecularMap" + i) != sourceMaterial.GetTexture("_SpecularMap" + i)) return true;
            if (destMaterial.GetTexture("_EmissionMap" + i) != sourceMaterial.GetTexture("_EmissionMap" + i)) return true;
        }

        if (destMaterial.GetColor("_Dirt1Tint") != sourceMaterial.GetColor("_Dirt1Tint")) return true;
        if (destMaterial.GetColor("_Dirt2Tint") != sourceMaterial.GetColor("_Dirt2Tint")) return true;
        if (destMaterial.GetColor("_0EmissionTint") != sourceMaterial.GetColor("_0EmissionTint")) return true;
        if (destMaterial.GetColor("_1EmissionTint") != sourceMaterial.GetColor("_1EmissionTint")) return true;
    ...
    void CopySurforgeMaterialComplete(Material sourceMaterial,  Material destMaterial) {
		...
		for (int i=0; i<8; i++) {
            ...
            destMaterial.SetFloat("_" + i + "AlbedoIntensity", sourceMaterial.GetFloat("_" + i + "AlbedoIntensity"));
            destMaterial.SetFloat("_" + i + "MAlbedoIntensity", sourceMaterial.GetFloat("_" + i + "MAlbedoIntensity"));
            destMaterial.SetColor("_MTint" + i, sourceMaterial.GetColor("_MTint" + i));
            destMaterial.SetFloat("_Metallic" + i, sourceMaterial.GetFloat("_Metallic" + i));
            destMaterial.SetColor("_" + i + "MUnderlyingDiffuseTint", sourceMaterial.GetColor("_" + i + "MUnderlyingDiffuseTint"));
            destMaterial.SetFloat("_" + i + "UnderlyingMetallic", sourceMaterial.GetFloat("_" + i + "UnderlyingMetallic"));
            destMaterial.SetFloat("_" + i + "Paint1Metallic", sourceMaterial.GetFloat("_" + i + "Paint1Metallic"));
            destMaterial.SetFloat("_" + i + "Paint2Metallic", sourceMaterial.GetFloat("_" + i + "Paint2Metallic"));
            destMaterial.SetColor("_" + i + "Paint1MColor", sourceMaterial.GetColor("_" + i + "Paint1MColor"));
            destMaterial.SetColor("_" + i + "Paint2MColor", sourceMaterial.GetColor("_" + i + "Paint2MColor"));
